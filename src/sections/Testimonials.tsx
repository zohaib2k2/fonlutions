...
const testimonials = [
  {
    ...
    image: testimonial1,
    content:
      'fonlutions transformed our vision into reality. Their full-stack development team delivered a robust platform that scaled seamlessly with our growth. The attention to detail and technical expertise exceeded our expectations.',
    rating: 5,
  },
  {
    name: 'Michael Chen',
    ...
    image: testimonial2,
    content:
      'The DevOps automation fonlutions implemented reduced our deployment time by 70%. Their team is professional, responsive, and truly understands modern infrastructure needs. Highly recommended!',
    rating: 5,
  },
  {
    name: 'David Park',
    ...
    image: testimonial3,
    content:
      'fonlutions\'s CCTV installation service was exceptional. They designed a comprehensive security system for our facilities with remote monitoring capabilities. The support team is always available when we need them.',
    rating: 5,
  },
];
